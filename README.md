...
mtghubot is a chat bot built on the [Hubot][hubot] framework. It was
...
### Running mtghubot Locally

You can test your hubot by running the following, however some plugins will not
behave as expected unless the [environment variables](#configuration) they rely
upon have been set.

You can start mtghubot locally by running:
...
Then you can interact with mtghubot by typing `mtghubot help`.

    mtghubot> mtghubot help
    mtghubot animate me <query> - The same thing as `image me`, except adds [snip]
    mtghubot help - Displays all of the help commands that mtghubot knows about.
    ...
